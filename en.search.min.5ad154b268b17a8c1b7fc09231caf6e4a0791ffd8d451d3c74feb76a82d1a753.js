...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.175492c8355bbc8d4bd3f47a5e6c7afd02cac8580d9b4062853723c007735461.js',function(){input.required=false;search();});}
