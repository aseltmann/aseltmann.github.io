...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.866a0a6a7e6f796fefd221cf1953e8b4c9933c14bd19c66253dcecc928e0214a.js',function(){input.required=false;search();});}
